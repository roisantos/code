#!/bin/bash
#SBATCH -J Rolt       # Nombre del trabajo
#SBATCH -o Rolt_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e Rolt_error_%j.log    # Archivo para la salida de errores
...
cd /home/usc/ec/rsm/boltsegmentor/

#!/bin/bash
#SBATCH -J RoiB4x1.5        # Nombre del trabajo
#SBATCH -o RoiB4x1.5_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e RoiB4x1.5_error_%j.log    # Archivo para la salida de errores
